...
- 95% CI = [0.00, 0.67]: 95% confidence interval for the location difference in square brackets to provide the interval estimation for the effect size you report. 
