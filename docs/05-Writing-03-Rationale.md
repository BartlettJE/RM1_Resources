...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_LMATZCLICU'><label><input type="radio" autocomplete="off" name="radio_LMATZCLICU" value="x"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_LMATZCLICU" value="x"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_LMATZCLICU" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_LMATZCLICU" value="answer"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_WXBKHHFLLL'><label><input type="radio" autocomplete="off" name="radio_WXBKHHFLLL" value="x"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_WXBKHHFLLL" value="answer"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_WXBKHHFLLL" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_WXBKHHFLLL" value="x"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_FLBYDNWIPF'><label><input type="radio" autocomplete="off" name="radio_FLBYDNWIPF" value="answer"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_FLBYDNWIPF" value="x"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_FLBYDNWIPF" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_FLBYDNWIPF" value="x"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
