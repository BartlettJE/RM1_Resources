...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_APXJQSJOXR'><label><input type="radio" autocomplete="off" name="radio_APXJQSJOXR" value="x"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_APXJQSJOXR" value="answer"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_APXJQSJOXR" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_APXJQSJOXR" value="x"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_GFYSGQTCST'><label><input type="radio" autocomplete="off" name="radio_GFYSGQTCST" value="answer"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_GFYSGQTCST" value="x"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_GFYSGQTCST" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_GFYSGQTCST" value="x"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
