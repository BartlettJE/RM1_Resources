...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_RBGZOBYNOC'><label><input type="radio" autocomplete="off" name="radio_RBGZOBYNOC" value="x"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_RBGZOBYNOC" value="x"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_RBGZOBYNOC" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_RBGZOBYNOC" value="answer"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_EWVRXFVBHZ'><label><input type="radio" autocomplete="off" name="radio_EWVRXFVBHZ" value="answer"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_EWVRXFVBHZ" value="x"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_EWVRXFVBHZ" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_EWVRXFVBHZ" value="x"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
