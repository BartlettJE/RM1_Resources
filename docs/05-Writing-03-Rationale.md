...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_ESGSVCFKLT'><label><input type="radio" autocomplete="off" name="radio_ESGSVCFKLT" value="x"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_ESGSVCFKLT" value="x"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_ESGSVCFKLT" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_ESGSVCFKLT" value="answer"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_PLCLBSTPYA'><label><input type="radio" autocomplete="off" name="radio_PLCLBSTPYA" value="x"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_PLCLBSTPYA" value="answer"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_PLCLBSTPYA" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_PLCLBSTPYA" value="x"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_CGWZVALNHU'><label><input type="radio" autocomplete="off" name="radio_CGWZVALNHU" value="answer"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_CGWZVALNHU" value="x"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_CGWZVALNHU" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_CGWZVALNHU" value="x"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
