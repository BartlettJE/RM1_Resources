...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_ELNYCRKUPQ'><label><input type="radio" autocomplete="off" name="radio_ELNYCRKUPQ" value="x"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_ELNYCRKUPQ" value="x"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_ELNYCRKUPQ" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_ELNYCRKUPQ" value="answer"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_SUDOEDJPEY'><label><input type="radio" autocomplete="off" name="radio_SUDOEDJPEY" value="x"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_SUDOEDJPEY" value="answer"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_SUDOEDJPEY" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_SUDOEDJPEY" value="x"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
...
- What is the most fitting type of rationale? <div class='webex-radiogroup' id='radio_XFNZJMKJKB'><label><input type="radio" autocomplete="off" name="radio_XFNZJMKJKB" value="answer"></input> <span>Exploring an under researched topic.</span></label><label><input type="radio" autocomplete="off" name="radio_XFNZJMKJKB" value="x"></input> <span>Direct replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_XFNZJMKJKB" value="x"></input> <span>Conceptual replication of a previous study.</span></label><label><input type="radio" autocomplete="off" name="radio_XFNZJMKJKB" value="x"></input> <span>Addressing limitations in the method of a previous study.</span></label></div>
