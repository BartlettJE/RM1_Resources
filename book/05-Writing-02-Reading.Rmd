...
Enter your keywords in the search bar of these databases. You can enter one word and they will try to locate resources that contain that word. For example, we might want to find additional articles investigating job candidates' speech. 

Figure for one key word. 
...
You can also use Boolean operators in Google Scholar to combine the search terms gender AND “hiring decisions”. This means we only want search results that contain both elements. 

Figure for Google scholar search terms. 
...
For further tips, see the library guide on [how to search for articles](https://www.gla.ac.uk/myglasgow/library/fulltextjournalarticles/searchforarticles/).  
...
If you like to follow along to a video, there are some helpful sources on YouTube to guide you through a lot of the basics: 
https://www.youtube.com/watch?v=BQL_7C-YqBk 
https://www.youtube.com/watch?v=Hm0TboOcAuM 

The Zotero website also has a quick start guide if you prefer a written explanation: https://www.zotero.org/support/quick_start_guide 
