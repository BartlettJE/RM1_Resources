...
```{r C8 version 1 figure, fig.alt = "Scatterplot for week 8 task version 1."}
...
```{r C8 version 2 figure, fig.alt = "Scatterplot for week 8 task version 2."}
include_graphics("images/08_Schroeder_violin_badbar.png")
```
...
Descriptive statistics for the mean intellect rating between recruiters in the audio and transcript conditions. 

```{r C8 version 3 table, fig.alt = "Table for week 8 task version 3."}
include_graphics("images/08_table.png")
```
...
```{r C8 version 4 figure, fig.alt = "Scatterplot for week 8 task version 4."}
include_graphics("images/08_Schroeder_violin.png")
```
...
```{r C8 version 5 figure, fig.alt = "Scatterplot for week 8 task version 5."}
include_graphics("images/08_Schroeder_violin_bad.png")
```
