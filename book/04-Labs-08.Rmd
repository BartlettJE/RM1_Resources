...
This week, we will also spend a little time on data visualisation, either through plots or tables. We will cover some key APA style elements for formatting tables and plots, and highlight some principles to keep in mind when visualising data. 
...
1. Final editing of your stage one report. 

## Next week

Data processing and Discussion part 1. 
