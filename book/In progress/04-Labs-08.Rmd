...
Descriptives statistics are presented in Table 1. A paired-samples t-test was conducted comparing guilt ratings before (M = 5.8, SD = 1.5 and after (M = 4.04, SD = 1.93 the critical evidence was heard by participants. A significant difference was found (t(74) = 8.23, p <.001) with time point 13 having a lower average rating that time point 12. 
